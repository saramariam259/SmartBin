...
public class driverregister extends AppCompatActivity {
                ...
                signup.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                                ...
                                if (user.equals("") || pass.equals("") || repass.equals("") || driverIdText.equals("") || nameText.equals("") || addressText.equals("") || cityText.equals("") || mobileText.equals("")) {
                                        ...
                                        Toast.makeText(driverregister.this, "Invalid email address", Toast.LENGTH_SHORT).show();
                                } else if (!isValidPhoneNumber(mobileText)) {
                                        Toast.makeText(driverregister.this, "Invalid phone number", Toast.LENGTH_SHORT).show();
                                } else if (!isValidAadhaarNumber(aadharText)) {
                                        Toast.makeText(driverregister.this, "Invalid Aadhaar number", Toast.LENGTH_SHORT).show();
                                } else {
        ...
        public boolean isValidPhoneNumber(String phoneNumber) {
                // Phone number validation pattern (all digits with 10 characters)
                String pattern = "\\d{10}";
                return phoneNumber.matches(pattern);
        }

        public boolean isValidAadhaarNumber(String aadhaarNumber) {
                // Aadhaar number validation pattern (all digits with 12 characters)
                String pattern = "\\d{12}";
                return aadhaarNumber.matches(pattern);
        }
}
